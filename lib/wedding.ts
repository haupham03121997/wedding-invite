...
export const WEDDING = {
  ...
  ceremony: {
    title: "Lễ Vu Quy",
    side: "Nhà gái",
    hosts: "Nhà gái: Bà Nguyễn Văn A", // TODO: điền họ tên đầy đủ của mẹ cô dâu
    time: "09:00, Chủ Nhật ngày 02.08.2026",
    address: "Tư gia nhà gái, Thôn Vĩnh Thiện, Xã Bù Đăng, Tp.Đồng Nai",
  },
